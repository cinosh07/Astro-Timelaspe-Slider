...
#ifdef debug
  String str = "";
  str = "Background brightness level = ";
  str += Params.BackgroundBrightnessLevel;
  Serial.println(str);
  str = "Interval                    = ";
  str += Params.Interval;
  Serial.println(str);
...
boolean EEPParams::crcOK()
{
  ...
  str = "Params.SumBytes      = ";
  str += String(Params.SumBytes, HEX);
  Serial.println(str);
  str = "Calced SumBytes      = ";
  str += String(CRCSumBytes, HEX);
  Serial.println(str);

  str = "Params.SumXORedBytes = ";
  str += String(Params.SumBytesXored, HEX);
  Serial.println(str);
  str = "Calced SumXORedBytes = ";
  str += String(CRCSumBytes ^ 0xFFFF, HEX);
  Serial.println(str);
#endif
